...
function(DownloadCEF remote_url file_system platform version download_dir)
  ...
  if(NOT IS_DIRECTORY "${CEF_ROOT}")
    ...
    if(NOT EXISTS "${CEF_DOWNLOAD_PATH}")
      set(CEF_DOWNLOAD_URL "${remote_url}/${CEF_DOWNLOAD_FILENAME}")
        
        if(file_system)
           file(COPY "${CEF_DOWNLOAD_URL}" DESTINATION "${CEF_DOWNLOAD_DIR}")
        else()
